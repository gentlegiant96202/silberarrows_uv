...
// Generate HTML content for Credit Note document (White background)
function generateCreditNoteHTML(data: any, logoSrc: string) {
  ...
  return `
    ...
    <body>
      <div class="page">
        <div class="stamp">CREDIT NOTE</div>
        
        <div class="header">
          <div class="title-section">
            <div class="title">Credit Note</div>
            <div class="subtitle">Invoice Adjustment</div>
          </div>
        ...
        <div class="note-box">
          <strong>Note:</strong> This credit note reduces the balance due on the referenced invoice. 
          The credit has been automatically applied to the customer's account.
        </div>

        <div class="signature-section">
          <div class="signature-box">
            <div class="signature-label">Authorized By (SilberArrows)</div>
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('[generate-credit-note] Request received:', { adjustmentId });
    ...
    if (adjustmentError || !adjustment) {
      console.error('[generate-credit-note] Adjustment fetch error:', adjustmentError);
      return NextResponse.json(
    ...
    // Generate HTML
    const htmlContent = generateCreditNoteHTML(templateData, logoSrc);
    ...
    if (!pdfShiftResponse.ok) {
      ...
      console.error('[generate-credit-note] PDFShift error:', errorText);
    ...
    const fileName = `credit-note-${adjustmentId}-${Date.now()}.pdf`;
