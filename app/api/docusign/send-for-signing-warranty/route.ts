...
export async function POST(request: NextRequest) {
  try {
    console.log('🔍 Warranty Contract DocuSign API called - parsing request body...');
    const { 
      contractId, 
      contractType, 
      customerEmail, 
    ...
    console.log('📧 Sending warranty contract for DocuSign signing...');
    ...
    console.log('🔍 Creating DocuSign envelope data for warranty contract...');
    ...
    console.log('✅ Warranty envelope data created, document count:', envelopeData.documents.length);
    console.log('✅ Warranty envelope data created, recipients count:', envelopeData.recipients.signers.length);

    // Send envelope creation request
    console.log('🔍 Sending warranty envelope to DocuSign API...');
    ...
    console.log('✅ DocuSign warranty envelope created:', envelopeId);

    // Update warranty_contracts table with DocuSign information
    console.log('💾 Updating warranty_contracts database with DocuSign envelope ID...');
    ...
    console.log('✅ Warranty contract database updated with DocuSign envelope ID');
    ...
    console.error('❌ Critical Error in Warranty DocuSign API:', {
