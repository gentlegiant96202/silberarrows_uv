-- Update the receivables summary view to correctly calculate totals
...
SELECT 
  ...
  SUM(balance_0_30) as days_0_30,
  SUM(balance_31_60) as days_31_60,
  SUM(balance_61_90) as days_61_90,
  SUM(balance_91_plus) as days_91_plus
