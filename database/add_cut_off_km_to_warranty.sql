...
-- 5. Add workflow_status field (if missing) - Note: this field may already exist from previous migrations
-- ALTER TABLE warranty_contracts 
-- ADD COLUMN IF NOT EXISTS workflow_status workflow_status_enum DEFAULT 'created';
...
-- Note: workflow_status should already have correct enum values from previous migrations

-- 9. Success message
DO $$
BEGIN
    RAISE NOTICE 'Warranty contracts table updated successfully!';
    RAISE NOTICE 'Added fields: cut_off_km, customer_id_type, customer_id_number, exterior_colour, interior_colour, invoice_amount, reservation_id';
