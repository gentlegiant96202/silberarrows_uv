...
export const generateMondayTemplate = (
  ...
  if (templateType === 'A') {
    // EXACT copy of original Monday Template A with Instagram Story Animations
    return `
      <!DOCTYPE html>
      <html lang="en">
      <head>
...
${fontFaceCSS}
      ...
      <div class="content-card">
        <div class="image-section">
          <img src="${renderImageUrl}" class="background-image" referrerpolicy="no-referrer" loading="eager" decoding="sync" />
        </div>
        
        <div class="content">
          <div class="badge-row">
            <div class="badge"><i class="fas fa-exclamation-triangle" style="margin-right:6px;"></i> ${formData.badgeText || 'MYTH BUSTER MONDAY'}</div>
            <img src="${absoluteLogoUrl}" alt="SilberArrows Logo" class="company-logo-inline" referrerpolicy="no-referrer" onerror="this.onerror=null;this.src='https://database.silberarrows.com/storage/v1/object/public/media-files/8bc3b696-bcb6-469e-9993-030fdc903ee5/9740bc7d-d555-4c9b-b0e0-d756e0b4c50d.png';" />
          </div>
    ...
    // EXACT copy of original Monday Template B with Instagram Story Animations
    return `
      <!DOCTYPE html>
      <html lang="en">
      <head>
...
${fontFaceCSS}
      ...
      <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; -webkit-font-smoothing: antialiased; }
        ...
        .myth-section {
          animation: mythFactSlide 0.8s ease-out 1.5s both;
        }
        ...
        .fact-section {
          animation: mythFactSlide 0.8s ease-out 1.8s both;
        }
