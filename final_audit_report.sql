-- =====================================================
-- FINAL AUDIT REPORT: CAR DELETION INCIDENT
-- =====================================================
...
SELECT
    ...
    'Unauthorized data deletion operations detected' as incident_type,
...
SELECT
    ...
    'User executed deletion operations affecting car inventory data' as activity_summary
FROM auth.users
