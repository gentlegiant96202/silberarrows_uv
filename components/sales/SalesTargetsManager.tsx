        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-white/60 text-sm">Set monthly targets for sales department performance</p>
            </div>
          </div>
        ...
        <div className="p-4 border-b border-white/10 bg-white/5 backdrop-blur-sm">
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div>
              ...
              >
                {MONTHS.map(month => (
                  <option key={month.value} value={month.value}>{month.label}</option>
                         ...
                         <div>
               <label className="block text-sm font-medium text-white mb-1">Gross Profit Year Target (AED)</label>
               <input
                 type="number"
             ...
             <div>
               <label className="block text-sm font-medium text-white mb-1">Gross Profit Month Target (AED)</label>
               <input
                 type="number"
