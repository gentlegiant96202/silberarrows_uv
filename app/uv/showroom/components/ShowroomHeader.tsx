        ...
        <div className="header-inner">
          ...
          <div className="header-right">
            <nav className="header-nav">
              {showBackButton ? (
                <a onClick={() => router.push('/uv/showroom')} style={{ cursor: 'pointer' }}>← Back to Inventory</a>
              ) : (
                <>
                  <a href="/uv/showroom">HOME</a>
        ...
        <div className="mobile-menu-overlay" onClick={() => setMobileMenuOpen(false)}>
          <div className="mobile-menu" onClick={(e) => e.stopPropagation()}>
            ...
            <nav className="mobile-nav">
              {showBackButton ? (
                <a onClick={() => { setMobileMenuOpen(false); router.push('/uv/showroom'); }} style={{ cursor: 'pointer' }}>
                  ← Back to Inventory
                </a>
              ) : (
                <>
                  <a href="/uv/showroom" onClick={() => setMobileMenuOpen(false)}>HOME</a>
