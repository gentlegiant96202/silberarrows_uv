...
export const generateMondayTemplate = (
  ...
  if (templateType === 'A') {
    // EXACT copy of original Monday Template A from ContentPillarModal.tsx line 691-812
    return `
      <!DOCTYPE html>
      <html lang="en">
      <head>
...
${fontFaceCSS}
    ...
    // EXACT copy of original Monday Template B from ContentPillarModal.tsx line 2057-2368
    return `
      <!DOCTYPE html>
      <html lang="en">
      <head>
