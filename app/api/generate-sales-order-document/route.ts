...
I confirm that the above vehicle details, pricing, and terms are correct and agreed. I understand that this Sales Order serves as a binding agreement upon signature.
      ...
      <div class="page page-break">
        <div class="header">
          <div class="title-section">
            <div class="title">GENERAL TERMS & CONDITIONS FOR<br>PRE-OWNED VEHICLE RESERVATION</div>
          </div>
          <img src="${logoSrc}" alt="SilberArrows Logo" class="logo">
        </div>
...
• For vehicles without any manufacturer's warranty and/or dealer service package, SilberArrows offers the Extended Warranty and ServiceCare products. If the customer has chosen to purchase one or both products, the prices are detailed in the 'ADD-ONS' section of the reservation form.
