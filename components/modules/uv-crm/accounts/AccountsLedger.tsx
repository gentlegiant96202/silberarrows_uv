          ...
          <table className="w-full border-collapse border border-white/20">
            <thead className="sticky top-0 bg-zinc-900 z-10">
              <tr>
                ...
                <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-white/70 uppercase tracking-wider border border-white/20 bg-zinc-800 w-20">
                  Type
                </th>
                ...
                <th className="px-3 py-2.5 text-right text-[10px] font-semibold text-white/70 uppercase tracking-wider border border-white/20 bg-zinc-800 w-24">
                  Debit
                </th>
                <th className="px-3 py-2.5 text-right text-[10px] font-semibold text-white/70 uppercase tracking-wider border border-white/20 bg-zinc-800 w-24">
                  Credit
              ...
              {entriesWithBalance.map((entry, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-3 py-2 border border-white/20 bg-black">
                      <span className={`inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-[10px] font-medium ${getTransactionColor(entry.entry_type)}`}>
                        {getTransactionIcon(entry.entry_type)}
                        {getTransactionLabel(entry.entry_type)}
                      </span>
                    </td>
                    <td className="px-3 py-2 border border-white/20 bg-black">
                      <span className="text-xs font-mono text-amber-400">{entry.document_number}</span>
                    </td>
                    <td className="px-3 py-2 border border-white/20 bg-black">
                    ...
                    <td className="px-2 py-2 border border-white/20 bg-black text-center" onClick={(e) => e.stopPropagation()}>
                      {generatingPdf === entry.id ? (
                        <Loader2 className="w-3.5 h-3.5 animate-spin text-white/50 mx-auto" />
                      ) : (
                        <button
