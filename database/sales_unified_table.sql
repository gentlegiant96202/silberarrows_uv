-- Unified Sales Department Tracking System
...
SELECT * FROM sales_daily_inputs;

CREATE TABLE IF NOT EXISTS sales_calculated_metrics_backup AS 
SELECT * FROM sales_calculated_metrics;
...
DECLARE
    target_rec RECORD;
    avg_profit_per_car DECIMAL(12,2);
    marketing_rate DECIMAL(5,2);
BEGIN
...
SELECT 'Unified sales metrics table created successfully!' as status; 