      ...
      <head>
          ...
          <style>
              ...
              * {
              ...
              /* Add spacing div for subsequent pages */
              .page-spacer {
                  height: 40px;
                  background: linear-gradient(135deg, #0a0a0a 0%, #1a1a1a 50%, #000000 100%);
      ...
      <body>
          <div class="quotation-container">
              ...
              <div class="content-wrapper">
                  <!-- Top Row: Specifications + Images -->
                  <div class="top-row">
                      <!-- Specifications with Pricing -->
                      <div class="card">
                  ...
                  <div class="pricing-section">
                      ...
                      <div class="main-price">
                          ...
                          <div class="main-price-value">AED ${car.advertised_price_aed?.toLocaleString() || '—'}</div>
                      </div>
                      ${(() => {
                        ...
                        <div class="payment-options">
                            <div class="payment-option">
                                ...
                                <div class="payment-option-value">AED ${m0}/mo</div>
                            </div>
                            <div class="payment-option">
                                <div class="payment-option-label">Monthly (20% Down)</div>
                                <div class="payment-option-value">AED ${m20}/mo</div>
                            </div>
                        </div>`;
                      })()}
                  </div>
                  ...
                  <!-- Key Equipment Section - Full Width -->
                  ${equipItems.length ? `
                  <div class="full-width-section">
              ...
              <div class="footer">
                  ...
                  <p>All prices are exclusive of VAT • Finance options available • Trade-ins welcome</p>
