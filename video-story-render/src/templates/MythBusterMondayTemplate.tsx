...
export const MythBusterMondayTemplate: React.FC<MondayTemplateProps> = (props) => {
  const {
    title = 'Sample Title',
    subtitle = '',
    description = '',
    ...
    <div style={{
        ...
        <div style={{ marginBottom: '24px' }}>
          ...
          {myth && (
            <div style={{
              ...
              transform: `translateY(${slideFromTop(45)}px)`,
              opacity: fadeIn(45)
            }}>
              <div style={{
                display: 'flex',
      ...
      {fact && (
          <div style={{
            ...
            backdropFilter: 'blur(10px)',
              boxShadow: '0 4px 20px rgba(0, 0, 0, 0.15)',
              transform: `translateY(${slideFromTop(60)}px)`,
              opacity: fadeIn(60)
            }}>
              <div style={{
                display: 'flex',
