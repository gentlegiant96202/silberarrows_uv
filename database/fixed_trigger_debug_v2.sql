-- Fixed trigger debugging - corrected RAISE NOTICE syntax
...
-- 2. Create new function with logging (fixed RAISE NOTICE syntax)
...
BEGIN
    ...
    RAISE NOTICE 'Final Year percentage: %', NEW.gross_profit_year_achieved_percentage;
    RAISE NOTICE 'Final Month percentage: %', NEW.gross_profit_month_achieved_percentage;
    RAISE NOTICE 'Final Profit per car: %', NEW.average_gross_profit_per_car_month;
    RAISE NOTICE 'Final Marketing rate: %', NEW.marketing_rate_against_gross_profit;
